...
require a continuous revision of the standards and protocols to support this new
data.}.
...
\rem{MA}{Relevance of distributed virtual centers}

\rem{MA}{We need to define very well the objective of the paper and the intended
audience}

\rem{MA}{Paper outline and teaser of conclusions}
