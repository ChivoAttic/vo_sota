...
here that around the 85\% of the resources are concentrated in one publisher,
...
the SIA standard. This results arises naturally from the fact that every
...
One of the interesting queries that can be asked to the registry is
