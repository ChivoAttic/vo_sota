...
orginized VOs still include their organizational branches in the publisher field,
...
scarse compared to imaging instruments in the observatories. Also, is very likely that for each
...
\hline
\textbf{VO} & Resources & GR & XR & EU & UV & OP & IR & ML & RD \\
\hline
\hline
  ESO - Science Archive Facility & 1  & & & & X & X & X & & \\
\hline
  Space Telescope Science Institute & 2 & & & & X & & & & \\
\hline
  VO-Paris - LUTH & 1  & X & & & & & & & \\
\hline
  INTA/LAEFF & 1  & & & & & X & & & \\
\hline
  WFAU, Institute for Astronomy & 1 & & & & & X & & & \\
\hline
  MAST & 10  & & & X & X & X & & & \\
\hline
  Institut d'Astrophysique de Paris & 1  & & & X & & & & & \\
\hline
  Space Telescope Science Institute & 1 & & & & X & X & X & & \\
\hline
  VO-Paris - IMCCE & 1  & & & & & X & X & & \\
\hline
  WFAU & 1  & X & X & & & & & & \\
\hline
  JVO & 1  & & & & & X & & & \\
\hline
  Instituto de Astrofsica de Andaluca & 1 & & & & X & X & X & & \\
\hline
  VO-Paris Data Centre - GEPI  & 2 & & & & & X & & & \\
\hline
  Laboratoire d'Astrophysique de Marseille & 1 & & & & & X & & & \\
\hline
  Instituto de Astrofsica de Andaluca & 1  & & X & & X & X & X & & \\
\hline
  VO-Paris Data Centre - LESIA  & 1  & & & & X & X & & & \\
\hline
  GAVO DC team  & 5  & & & & X & X & X & & \\
\hline
  NASA/IPAC Extragalactic Database & 1  & X & X & X & X & X & X & X & X \\
\hline
  LUPM & 1  & & & & X & X & & & \\
\hline
  CRAL-Observatoire de Lyon & 1 & & & & & X & & & \\
\hline
  Ivo://Bass2000 & 1 & & & & & X & & & \\
\hline
\end{tabular}
...
milimiter and radio resources are scarse, which is stange in the sense that most of the instruments in these
...
as a suggestion in the registry standard. Impresively, this suggestion has been strongly followed by the VO.
...
more specific ones, such as variable stars or open clusters, can be very usefull tags for selecting
resources. An interesting result here is that 715 resources declare to be spectroscopy data\footnote{Moreover, this number does not include tags that are implicitely spectroscopy data such as ``Galaxies:spectra''.}, but we
...
much more effort and metadata than SCS, so the VOs may not consider prioritary to mount this service.
In any case, an improved spectral access standard is being developed.

Please note that the queries perfomed in the past sections can be easely combined. For example,
