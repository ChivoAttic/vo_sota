...
\begin{itemize}
\item \textbf{Description:} a service which allows users to share files and
collaborate with team members.
\end{itemize}
\item Table Access Protocol (TAP-1.0)
\begin{itemize}
\item \textbf{Description:} a service which allows the access to all the data
...
\begin{itemize}
\item \textbf{Description:} a model which implements a standard view for
