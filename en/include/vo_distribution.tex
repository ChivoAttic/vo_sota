...
worldwide is shown. The founders and first members are the same countries that have
...
defines 3 layers:
\begin{itemize}
        \item the \textbf{Resource Layer} consist in a server
...
For the creation and update of standards and protocols, IVOA has the
...
Each of these working groups define several standards that can be
found in IVOA website\footnote{}.
