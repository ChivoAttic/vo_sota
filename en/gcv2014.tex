...
\title{A Survey on the Virtual Observatory and the Upcoming Challenges}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Jos\'e Marroqu\'in \and Mauricio Solar \and Mauricio
Araya \and Jonathan Antognini \and Diego Mardones \and Karim Pichara \and
Ricardo Contreras \and Victor Parada}}
...
\begin{abstract}
%\boldmath
This paper present a short survey on the astronomical Virtual Observatories (VOs) that are 
